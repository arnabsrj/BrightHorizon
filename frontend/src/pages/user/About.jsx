    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 to-blue-900 pt-32 pb-24 overflow-hidden -mt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center text-white">
          ...
          </h1>relative max-w-7xl mx-auto px-6 lg:px-8 text-center text-white
      ...
      <section className="py-20 px-6 lg:px-8 bg-white">
        <div className="max-w-5xl mx-auto text-center md:text-left animate-fadeIn">
          ...
          <div className="text-lg text-slate-700 leading-relaxed space-y-6">
            <p>
              <span className="font-semibold text-blue-600">BrightHorizon Infotech</span> is a dynamic SAP
              consulting firm that specializes in providing high-quality SAP solutions and services to businesses
              across various industries.
            </p>
            <p>
              Our team of experienced SAP consultants has the expertise and knowledge to help businesses optimize
              their SAP systems and processes, increase efficiency, and drive growth.
            </p>
            <p>
              Our team of consultants brings a wealth of experience in managing complex implementation, rollout,
              and support projects across multiple regions as well as Corporate Trainings.
            </p>
            <p>
              Our strengths lie in our ability to implement best practices across countries, maintain a high degree
              of process proficiency, and retain and build knowledge.
            </p>
          </div>
        </div>
      </section>
