...
const Services = () => {
  ...
  const serviceCategories = [
    ...
    {
      category: "SAP Basis & Operations",
      icon: <Wrench className="w-6 h-6" />,
      color: "from-orange-500 to-red-500",
      services: [
        {
          title: "SAP Basis Administration",
          desc: "End-to-end system administration, performance tuning, and security management.",
          icon: <Settings className="w-8 h-8" />,
          features: [
            "System monitoring",
            "Transport management",
            "HANA & OS/DB migration",
          ],
      ...
      <div ref={sectionRef} className="relative min-h-screen pt-20">
        ...
        <section className="bg-gradient-to-br from-slate-50 via-white to-slate-50 py-16 px-6">
          <div className="max-w-7xl mx-auto space-y-20">
            ...
            {/* Legacy Services (Optional: Keep or Remove) */}
            <div>
              <motion.div
                initial={{ opacity: 0, x: -50 }}
                animate={inView ? { opacity: 1, x: 0 } : {}}
