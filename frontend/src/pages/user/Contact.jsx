    ...
    We’re Here to Build Something Extraordinary Together
      ...
      <Container maxWidth="lg">
        ...
        <motion.div
          ...
          className="text-center mb-12 mt-52"
        >
          <Typography
            variant="h2"
            sx={{
        ...
        >
          ...
          >
            ...
            <Typography variant="body1">
              Mobile: <strong style={{ color: '#1f2937' }}>9014021004</strong>
            </Typography>
          </Box>
          ...
          >
            ...
            <Typography sx={{ fontSize: '0.95rem', color: '#4b5563' }}>
              ...
              Madhapur, Hitech City, Hyderabad, India.
            </Typography>
          </Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
                ...
                <Typography variant="body1" color="text.primary">
                  <a href="mailto:info@brighthorizon.co.in" style={{ color: 'inherit', textDecoration: 'none' }}>
                    <strong>info@brighthorizon.co.in</strong>
                  </a>
                </Typography>
              </Box>
            </Grid>
