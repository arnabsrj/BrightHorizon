    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link to="/" onClick={closeMenu} className="text-lg font-medium hover:text-blue-400 transition-colors">
              Home
            </Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 top-full mt-2 w-56 bg-gray-800 rounded-lg shadow-lg border border-gray-700 z-50 opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 top-full mt-2 w-80 bg-gray-800 rounded-lg shadow-lg border border-gray-700 z-50 opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200">
                
                {/* Our Services – Submenu */}
                <div className="relative group/item">
                  <button className="w-full text-left flex justify-between items-center px-4 py-2 text-sm font-semibold hover:bg-gray-700 text-blue-300">
                    Our Services <ChevronRight className="w-4 h-4" />
                  </button>

                  {/* Submenu – Opens to the LEFT */}
                  <div className="absolute right-full top-0 mr-1 w-80 bg-gray-800 rounded-lg shadow-lg border border-gray-700 z-50 opacity-0 invisible -translate-x-1 group-hover/item:opacity-100 group-hover/item:visible group-hover/item:translate-x-0 transition-all duration-200 max-h-96 overflow-y-auto">
            ...
            <Link to="/blogs" onClick={closeMenu} className="text-lg font-medium hover:text-blue-400 transition-colors">
              Blogs
            </Link>
            <Link to="/contact" onClick={closeMenu} className="text-lg font-medium hover:text-blue-400 transition-colors">
              Contact Us
            </Link>
          </div>
      ...
      >
        <div className="px-4 pt-2 pb-4 space-y-2 bg-gray-800 border-t border-gray-700">
          <Link to="/" onClick={closeMenu} className="block py-2 text-lg font-medium hover:text-blue-400 transition-colors">
            Home
          </Link>
